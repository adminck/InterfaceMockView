        ...
        <el-container :class="[isSider?'openside':'hideside',isMobile ? 'mobile': '']">
            ...
            <el-aside class="main-cont main-left">
                <div class="tilte">
                    ...
                    <h2 class="tit-text" v-if="isSider">接口Mock平台</h2>
                </div>
                <Aside class="aside" />
            </el-aside>
...
import Screenfull from '@/views/home/screenfull'
import HistoryComponent from '@/views/home/history'
          ...
          this.$refs.modifyPwdForm.validate(valid => {
              if (valid) {
                  changePassword({
                      ...
                      rePassword: this.pwdModify.newPassword
                  }).then(() => {
